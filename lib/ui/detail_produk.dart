...
:  super(key:  key);
//Variabel  yang  digunakan  untuk  menampung  parameter  tersebut final  
String  name;
...
final childrenstar  =  <Widget>[]; @override
//membuat  widget
...
body:  new  Container( width:  double.infinity,
...
padding:  EdgeInsets.all(10), child:  new  Row(
...
style:  new  TextStyle(
fontSize:  18.0,
fontWeight:  FontWeight.bold, color:  Colors.white, fontFamily:  "NeoSansBold"),
),
)
],
),
